...
module.exports = function ($sprite, index) {
    ...
    if (_props.rotate) {
        // 定点旋转
        _props.rx = utils.firstValuable(utils.funcOrValue($sprite.style.rx, $sprite), _props.tx + 0.5 * _props.tw);
        _props.ry = utils.firstValuable(utils.funcOrValue($sprite.style.ry, $sprite), _props.ty + 0.5 * _props.th);
