(function e(t, r) {
    ...
    return function(e) {
        ...
        R.extend = function(e) {
            var t = R.sprite.prototype.$extendList;
            if (t.indexOf(e) >= 0) return;
            t.push(e);
        };
        R.use = function(e) {
            var t = R.painter.prototype.$extendList;
            if (t.indexOf(e) >= 0) return;
            if (e.onUse) {
                e.onUse(R);
            }
        ...
        e.exports = function(e, t) {
            ...
            if (true) {
                if (window[o.default.devFlag] && window[o.default.devFlag].selectMode && p.length) {
                    ...
                    if (g && r.$plugin.selectSprite(e.type === "click" || e.type === "touchend", r, g)) {
                        return;
                    }
                }
            }
                ...
                if (typeof o === "string" || typeof o === "number") {
                    ...
                    o.forEach(function(t) {
                        r.$children.push({
                            ...
                            settings: a,
                            props: {
                                tx: R + n.default.funcOrValue(t.tx, e),
                                ty: S + n.default.funcOrValue(t.ty, e),
