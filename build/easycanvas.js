...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _clear = __webpack_require__(16);
	...
	var _apiGetOuterRect = __webpack_require__(32);

	var _apiGetOuterRect2 = _interopRequireDefault(_apiGetOuterRect);

	var _apiCombine = __webpack_require__(31);
	...
	sprite.prototype.getStyle = function (key) {
	    var $sprite = this;
	    var lastPaintTime = $sprite.$canvas.$lastPaintTime;
...
/***/ (function(module, exports) {
	...
	module.exports = function () {
	    ...
	    var outerRect = $sprite.getOuterRect();
...
/***/ (function(module, exports) {
	...
	module.exports = function () {
	    ...
	    this.children.forEach(function (child) {
	        var childRect = child.getOuterRect();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _chromeDevtool = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    for (var i = 0; i < l; i++) {
	        ...
	        if (hitSprite(item, e)) {
	            if (item.events.interceptor) {
	                var $e = _utils2.default.firstValuable(item.events.interceptor.call(item, e), e);
	        ...
	        if (hitSprite(item, e)) {
	            caughts.push(item);
	            var result = triggerEventOnSprite(item, e);
	...
	var triggerEventOnSprite = function triggerEventOnSprite($sprite, $e) {
	    if (!$sprite.events || !$sprite.events[$e.type]) return;
	    if ($e.$stopPropagation) return;

	    var result = $sprite.events[$e.type].call($sprite, $e);
	...
	_eventHandler = function eventHandler(e, _$e) {
	    ...
	    _utils2.default.execFuncs($canvas.hooks.afterEvent, $canvas, $e);
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	        ...
	        if (window[_constants2.default.devFlag] && window[_constants2.default.devFlag].selectMode && caughts.length) {
	            var devIndex = 0;
	            var chooseSprite = caughts[devIndex];
	            while (chooseSprite && chooseSprite.name === _constants2.default.devFlag) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _perPaintGetComputedStyle = __webpack_require__(46);

	var _perPaintGetComputedStyle2 = _interopRequireDefault(_perPaintGetComputedStyle);

	var _perPaintCutOutside = __webpack_require__(44);

	var _perPaintCutOutside2 = _interopRequireDefault(_perPaintCutOutside);

	var _perPaintDeliverChildren = __webpack_require__(45);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _remove = __webpack_require__(55);
	...
	var _paint = __webpack_require__(52);
	...
	var _pause = __webpack_require__(53);
	...
	var _setFpsHandler = __webpack_require__(56);

	var _setFpsHandler2 = _interopRequireDefault(_setFpsHandler);

	var _setMaxFps = __webpack_require__(57);
	...
	module.exports = function () {
	    ...
	    setInterval(function () {
	        if (_this.eHoldingFlag) {
	            ...
	            _this.$eventHandler.call(_this, null, $e);
	        }
	    }, 100); // TODO
	        ...
	        var ApiPlugin = {
	            ...
	            selectSprite: function selectSprite(isChoosing, $canvas, $sprite) {
	                    ...
	                    $selectMask = $canvas.add({
	                        ...
	                        children: [{
	                            ...
	                            style: {
	                                ...
	                                ty: function ty() {
	                                    var res = maskRect.ty + maskRect.th + 20;
	                ...
	                $selectMaskParent.style.visible = function () {
	                    return window[_constants2.default.devFlag].selectMode && $sprite.$parent;
	                };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _apiInner = __webpack_require__(42);
