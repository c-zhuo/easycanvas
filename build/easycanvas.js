...
/***/ (function(module, exports, __webpack_require__) {
	...
	var looper = function looper(arr, e, caughts) {
	    ...
	    for (var i = 0; i < l; i++) {
	        ...
	        var hasHandle = item.events && item.events[e.type];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (i, index) {
	    ...
	    if (_props.scale !== 1) {
	        ...
	        var scaledParent = getScaledParent(i);

	        if (scaledParent) {
	            var scaledParentRect = scaledParent.getRect(i === scaledParent ? false : true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	    ...
	    var diffs = diffRender($canvas.$lastTickChildren, $canvas.$children);
