...
describe('Featrue.scale Test.', function () {
    it('Scale inherit correctly.', function (done) {
        setTimeout(() => {
            ...
            expect($Painter.$paintList[0].props.slice(5).join(',')).toBe('40,40,150,150');
            expect($Painter.$paintList[1].props.slice(5).join(',')).toBe('140,40,150,150');

            // tx/ty 100~130  ==>  85～145
            expect($Painter.$paintList[2].props.slice(5).join(',')).toBe('85,85,60,60');
